...
/**
 * Provides a Front_services block.
 *
 * @Block(
 *   id = "front_services",
 *   admin_label = @Translation("Front services Block"),
 *   category = @Translation("sharjah_dd"),
 * )
 */
final class FrontServicesBlock extends BlockBase implements ContainerFactoryPluginInterface
{
